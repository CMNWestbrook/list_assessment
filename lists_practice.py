...
#n_long_words(["house", "yay", "whatup", "yay", "meh"], 3)
...
def halvesies(numbers):
    ...
    the half::
        ...
        [0.5, 2.5]
    """
    number_list_divided_by_two = []
    for number in numbers:
        number_divided = float(number / 2)
        number_list_divided_by_two.append(number_divided)
    return number_list_divided_by_two
